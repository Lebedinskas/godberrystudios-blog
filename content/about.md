...
description: "Solo shop run by Tomas Lebedinskas from Lithuania. Small, sharp tools for the MCP era and writing about what shipping them actually looks like."
---

Hi — [Tomas](/author/tomas/) here. Godberry Studios is the one-person shop I run from Lithuania.

The work is small, sharp tools that let AI agents actually *do* things — extract, transform, publish — without the bloat of legacy SaaS. Pay per use. No seats. No meetings.
...
- **Write what you ship.** This blog is a working notebook — what actually got learned this week, not a marketing funnel.
...
- **[mcp-server-apify-starter](https://github.com/godberrystudios/mcp-server-apify-starter)** (MIT) — the pay-per-use MCP server starter that didn't exist when the first one shipped here.
- **[awesome-mcp-tools](https://github.com/godberrystudios/awesome-mcp-tools)** (CC0) — a curated MCP ecosystem directory.
