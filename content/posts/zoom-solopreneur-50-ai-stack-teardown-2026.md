...
What's load-bearing here is not exotic: video meetings (Zoom Workplace), structured notes captured during conversations, and a SaaS tool she ships herself. The pattern is "consulting-funded SaaS" — common among the strongest operators in the [n8n vs Make vs Zapier roundup](/posts/n8n-vs-make-vs-zapier-ai-agents-2026/). A documentation-heavy HR practice without AI capture eats 8–12 hours a week on note synthesis. With AI capture, that drops to 2–3.
...
Stack as % of revenue: under 1%. At this tier every dollar saved on tooling is margin, and most of the leverage comes from buying time back, not feature depth. The cheap-or-free options are collected in [free AI tools that replace expensive software](/posts/free-ai-tools-replace-expensive-software-2026/) — useful at this tier. This is roughly where I sit, fwiw: Hugo + Cloudflare Pages costs me $0, the GitHub org is free, the Apify actors I ship pay me per-event, and the heaviest line item on my own stack is a Claude subscription.
